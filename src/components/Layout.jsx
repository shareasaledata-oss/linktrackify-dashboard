        ...
        <div className="flex-1 px-3 py-4 overflow-y-auto">
          ...
          <nav className="space-y-0.5">
            <Link to="/profile"
              className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200"
              style={{
                background: location.pathname === "/profile" ? "rgba(0,229,255,0.1)" : "rgba(255,255,255,0.02)",
                color: location.pathname === "/profile" ? "#00E5FF" : "rgba(148,163,184,0.8)",
                border: location.pathname === "/profile" ? "1px solid rgba(0,229,255,0.18)" : "1px solid rgba(255,255,255,0.04)",
              }}>
              <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}
                style={{ color: location.pathname === "/profile" ? "#00E5FF" : "rgba(148,163,184,0.5)" }}>
...
function Topbar({ setOpen, title, subtitle }) {
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative ml-1 pl-3" style={{ borderLeft: "1px solid rgba(255,255,255,0.06)" }}>
          <button onClick={() => { setShowProfile(!showProfile); setShowNotifications(false); }}
            ...
            <div className="w-9 h-9 rounded-xl flex items-center justify-center"
              style={{ background: "linear-gradient(135deg, rgba(0,229,255,0.8), rgba(59,130,246,0.9))", boxShadow: "0 0 16px rgba(0,229,255,0.3)" }}>
  ...
  return (
    <div className="min-h-screen flex" style={{ background: "linear-gradient(160deg, #020a14 0%, #061220 30%, #030d1a 60%, #020810 100%)" }}>
      ...
      <div className="flex-1 lg:ml-64 flex flex-col relative z-10">
        <Topbar setOpen={setSidebarOpen} title={title} subtitle={subtitle} />
